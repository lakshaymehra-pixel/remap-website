                    ...
                    <div className="text_content" style={{ width: "95%" }}>
                        ...
                        <div className="flex flex-center content_row">
                            <div className="content_item" style={{ maxWidth: "90%" }}>
                                <p>
                                    <b>Baid Stock Broking Services Private Limited</b> ("we," "our,"
                                    "us") operates the https://www.salarytopup.com website (the
                        ...
                        <div className="flex flex-center content_row">
                            <div className="content_item" style={{ maxWidth: "90%" }}>
                                ...
                                <p className="mt10">
                                    At Salary Topup, your privacy and satisfaction are our top
                        ...
                        <div className="flex flex-center content_row">
                            <div className="content_item" style={{ maxWidth: "90%" }}>
                                <h2 className="mb15 mt10">Contact Our Team</h2>
                                <div className="ml20">
                                    ...
                                    <p className="mt10 flex flex-center">
                                        ...
                                        <span>+91- 9355753533</span>
                                    </p>
                                    <p className="mt10 flex flex-center">
                                        <MdEmail className="content_icon mr5" />
                                        <span>Customercare@salarytopup.com</span>
                                    </p>

                                    <p className="mt10 flex flex-center">
                                        <FaLocationArrow className="content_icon mr5" />
                                        <span>
                                            <p>Office No-101, First Floor,NN Mall, Mangalam Palace,Sector-3, Rohini Delhi-110085</p>
                                        </span>
                                    </p>
                                </div>
                                <p className="mt10">
                                    We are committed to resolving your concerns in a timely and
                                    efficient manner. Thank you for choosing Salary Topup.
                                </p>
                            </div>
                        </div>
                        <div className="flex flex-center content_row">
