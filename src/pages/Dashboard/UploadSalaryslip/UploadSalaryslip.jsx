    ...
    const submit = () =>{
      ...
      uploadProfilePhoto(param).then((resp) => {
        ...
        if (resp?.data?.Status === 1) {
          ...
          getProfileDaital();
          navigate("/my-dashboard/upload-utilitybill");
    ...
    <br />
       <BoxWrapper  className="w100" >
        ...
        <div className="formmainBox flex">
          <div className="left">
            <div className='center gap4 pointer' onClick={()=>goBack(navigate,"/my-dashboard/bank-upload")} >
                <img src={arrowIcon} alt="" /> <span>Back</span>
            </div>
          </div>
          <div className="right">
            <h2>Upload Your Salary slip <span style={{color:"red"}}>*</span></h2>
